-- Migration: add_combination_keywords_rpc
-- Description: RPC function to get keywords for a specific (row_value, col_value) combination
-- Returns keyword list with ranking info for drill-down from heatmap cells
--
