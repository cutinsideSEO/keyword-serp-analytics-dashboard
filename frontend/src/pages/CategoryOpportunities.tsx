        ...
        <>
          ...
          {nonBrandedData && nonBrandedData.brand_domains.length === 0 && (
            <div className="rounded-xl bg-gray-50 border border-gray-200 px-6 py-4 flex items-start gap-4">
              ...
              <div>
                <p className="text-sm font-semibold text-gray-900 mb-1">No domains mapped for this brand</p>
                <p className="text-sm text-muted-foreground">
          ...
          {nonBrandedData && (
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-lg font-semibold text-gray-900">Non-Branded Opportunities</h2>
                  <p className="text-sm text-muted-foreground">
          ...
          {competitorData && competitorData.modifier_groups.length > 0 && (
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-lg font-semibold text-gray-900">Competitor Branded Opportunities</h2>
                  <p className="text-sm text-muted-foreground">
